 ...
 */
final class Version20251217113115 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE organization_user (user_id INT NOT NULL, organization_id INT NOT NULL, INDEX IDX_B49AE8D4A76ED395 (user_id), INDEX IDX_B49AE8D432C8A3DE (organization_id), PRIMARY KEY (user_id, organization_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_0900_ai_ci` ENGINE = MyISAM COMMENT = \'\' ');
