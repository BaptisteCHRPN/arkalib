...
/**
 * Schéma initial complet, régénéré depuis les entités.
 *
 * Remplace les 8 anciennes migrations, qui supposaient que les tables de base
 * (user, organization, budget, ...) existaient déjà au lieu de les créer :
 * sur une base vierge, la toute première migration échouait.
 */
final class Version20260830141702 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Schéma initial complet';
    }
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE transaction_budget_line (transaction_id INT NOT NULL, budget_line_id INT NOT NULL, INDEX IDX_1759A38B2FC0CB0F (transaction_id), INDEX IDX_1759A38B8FF83FA3 (budget_line_id), PRIMARY KEY (transaction_id, budget_line_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
